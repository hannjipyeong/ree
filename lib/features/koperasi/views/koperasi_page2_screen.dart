...
class KoperasiPage2Screen extends StatefulWidget {
  const KoperasiPage2Screen({super.key});

  @override
  State<KoperasiPage2Screen> createState() => _KoperasiPage2ScreenState();
}
...
class _KoperasiPage2ScreenState extends State<KoperasiPage2Screen> {
  ...
  void _handleNext() {
    ...
    if (_formKey.currentState!.validate()) {
      Navigator.pushNamed(context, AppRoutes.koperasiPage3);
    }
  }
