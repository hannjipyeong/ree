...
<body>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="17" class="no-data">Tidak ada data order kontainer pada laporan ini.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="17" class="no-data">Tidak ada data order muatan cargo pada laporan ini.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
    ...
    <div class="footer">
        Laporan Rekapitulasi Operasional Dashboard &bull; Dicetak Otomatis oleh Sistem PT. Bintang Kepri Jaya pada {{ $tanggalCetak }}
    </div>
</body>
</html>
